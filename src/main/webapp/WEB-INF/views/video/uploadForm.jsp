         ...
         <div class="p-1 pt-3"> -->
			...
			<label>
					...
					<div id="hide100" style="display: none">
						홈 트레이닝<input type="checkbox" name="videoInterest_interest" value = "HOME TRAINING">
					</div>
					</div>
					...
					<div id="hide200" style="display: none">
						동요율동<input type="checkbox" name="videoInterest_interest" value = "KIDS">
						치어리딩<input type="checkbox" name="videoInterest_interest" value = "CHEERLEADING">
						Other<input type="checkbox" name="videoInterest_interest" value = "OTHER(TEENS)">
					</div>
					</div>
					...
					<div id="hide300" style="display: none">
						K-POP<input type="checkbox" name="videoInterest_interest" value = "K-POP">
						J-POP<input type="checkbox" name="videoInterest_interest" value = "J-POP">
						Others<input type="checkbox" name="videoInterest_interest" value = "OTHERS(CHOREO)">
					</div>
					</div>
					...
					<div id="hide400" style="display: none">
						MALE<input type="checkbox" name="videoInterestt_interest" value = "MALE CLUBDANCE">
						FEMALE<input type="checkbox" name="videoInterest_interest" value = "FEMALE CLUBDANCE">
						Others<input type="checkbox" name="videoInterest_interest" value = "OTHERS(CLUB)">
					</div>
					</div>
					...
					<div id="hide500" style="display: none">
						팝핀<input type="checkbox" name="videoInterest_interest" value = "POPPIN DANCE">
						B-BOY<input type="checkbox" name="videoInterest_interest" value = "BREAK DANCE">
						락킹<input type="checkbox" name="videoInterest_interest" value = "LOCKING">
						Others<input type="checkbox" name="videoInterest_interest" value = "OTHERS(HIPHOP)">
					</div>
					</div>
					...
					<div id="hide600" style="display: none">
						탱고<input type="checkbox" name="videoInterest_interest" value = "TANGO">
						탭댄스<input type="checkbox" name="videoInterest_interest" value = "TAP DANCE">
						발리댄스<input type="checkbox" name="videoInterest_interest" value = "BELLY DANCE">
						자이브<input type="checkbox" name="videoInterest_interest" value = "JIVE">
						재즈<input type="checkbox" name="videoInterest_interest" value = "JAZZ">
						Others<input type="checkbox" name="videoInterest_interest" value = "OTHERS">
					</div>
					</div><br>
