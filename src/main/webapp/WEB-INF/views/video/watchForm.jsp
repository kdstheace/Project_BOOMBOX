                    ...
                    <div class="container-fluid watch_video">
                        <div class="row pt-4">
                            <div class="col-md-12 video_box">
                                <player-chrome id="player-chrome">

                                    <video class="video_responsive" id="videoPlayer"
                                        src="/video/watch?video_id=${video.VIDEO_ID }" slot="media">
                                    </video>
                                    <player-control-bar>
                            ...
                            <div class="card">
                                <a href="#">
                                    <div class="row p-0">
                                        <div class="col-md-5">
                                            <img class="video_list_responsive"
                                                src="https://i.ytimg.com/vi/hoNb6HuNmU0/hq720.jpg" alt="image"
                                                width="100%" height="94">
                                        </div>
                                        <div class="col-md-7 p-0">
                                            <p class="mb-1 title"
