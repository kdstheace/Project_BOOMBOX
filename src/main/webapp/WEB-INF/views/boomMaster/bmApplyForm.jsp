...
function agree() {
	 var boommaster_cardImg = document.getElementById("boommaster_cardImg").value;
	var boommaster_sampleVideo = document.getElementById("boommaster_sampleVideo").value;
	var boommaster_careerImg = document.getElementById("boommaster_careerImg").value;
	var boommaster_intro = document.getElementById("boommaster_intro").value;


	if(boommaster_cardImg == null || boommaster_cardImg.length == 0){
	...
	if(boommaster_sampleVideo == null || boommaster_sampleVideo.length == 0){
		alert("샘플 영상을 업로드 해주세요.");
		return false;
	}


	if(boommaster_careerImg == null || boommaster_careerImg.length == 0){
		alert("샘플 사진을 입력해 해주세요.");
		return false;
	}

	if(boommaster_intro == null || boommaster_intro.length == 0){
		alert("자기소개를 입력해 해주세요.");
		return false;
	}
	...
	<div id="allSize" class="container">
		...
		<form action="/boomMaster/bmApply" method="post" enctype="multipart/form-data">
			...
			<label>
				...
				<input type="file" id="boommaster_cardImg" name="boommaster_cardImg"><br>
				<div class="line-box">
					<div class="line"></div>
				</div>
			</label>
			...
			<label>
				...
				<input type="file" id="boommaster_sampleVideo" name="boommaster_sampleVideo"><br>
				<div class="line-box">
					<div class="line"></div>
				</div>
			</label>
			...
			<label>
				...
				<input type="file" id="boommaster_careerImg" name="boommaster_careerImg"><br>
				<div class="line-box">
					<div class="line"></div>
				</div>
			</label>
...
<br>
				...
				<input class="butten" type="submit" value="붐마스터 신청하기" id="uploadsub" value="Upload" onclick="return agree();">
