...
function fn_bmCancelFormCheck(){
	...
	var result = confirm("정말로 취소 하시겠습니까?");
	if(result){
	    alert("신천완료 되었습니다.");
	}else{
	    alert("취소 되었습니다.");
	...
	<div id="allSize" class="container">
		...
		<form action="/boomMaster/bmCancel?boomMaster_User_Id=${sessionScope.loginId }" method="post"  onsubmit="return fn_bmCancelFormCheck();" >
			...
			<label>
				...
				<textarea class="form-control" name="content" id="content" cols="200" rows="3" ></textarea>
			<br>
				<div class="line-box">
					<div class="line"></div>
				</div>
				...
				<input class="butten" type="submit" value="붐마스터 취소하기">
