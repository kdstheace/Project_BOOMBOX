...
<body>
	...
	<div class="schoolMainMenu">
		...
		<a href="/school/clubDanceForm" class="btn btn-dark" style="width: 170px; height: 40px; font-size: 22px;  color: rgb(0, 56, 161); background-color: rgb(189, 225, 255);">클럽댄스</a> &emsp; 
